...
<head>
    ...
    <title>Password Reset OTP — My Bridge International</title> 
    <style>
        body {
            margin: 0;
            padding: 0;
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Email From Blood Bank</h1>
            <p class="header-subtitle">One quick step to verify your email</p>
        </div>

        <!-- Body -->
        <div class="body">
            <p class="greeting">Hi {{ $donor->full_name }},</p>
            ...
            <p>
                Before you can access your dashboard, please reset your password by clicking the button below:
            </p>

            <div class="cta-wrap">
                <a href="{{ $email }}" class="cta-btn">
                    Verify Email
                </a>
            </div>

            <p class="expiry-note">This email verification link will expire in <strong>30 minutes</strong>.</p>

            <hr class="divider" />

            <p style="font-size:14px; color:#64748b; margin:0 0 8px;">
                If the button above doesn't work, copy and paste the OTP below into your browser:
            </p>
            <div class="url-box">{{ $email }}</div>
